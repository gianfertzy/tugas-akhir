                ...
                <div class="row mt-20">
                    <div class="col-lg-12 mt-30">
                        <div class="rd-products__nav ul_li_between mb-20">
                            ...
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                ...
                                @foreach ($merks as $merk)
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="tx-tab-0{{ $merk->id }}" data-bs-toggle="tab"
                                            data-bs-target="#tx-tab{{ $merk->id }}" type="button" role="tab"
                                            aria-controls="tx-tab{{ $merk->id }}"
                                            aria-selected="true">{{ $merk->name }}</button>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="tab-content mb-3">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="product__item style-2">
                                                ...
                                                <div class="product__content">
                                                    <h2 class="product__title"><a href="{{route('user.produk.detail', ['id' => $prod->id])}}">{{$prod->name}}</a></h2>
                            ...
                            @foreach ($merks as $merk)
                                <div class="tab-pane animated fadeInUp" id="tx-tab{{ $merk->id }}" role="tabpanel"
                                    aria-labelledby="tx-tab-0{{ $merk->id }}">
                                    <div class="row g-0">
                                        @foreach ($merk->produks as $prod)
                                            <div class="col-lg-3 col-md-6">
                                                <div class="product__item style-2">
                                                    <div class="product__img text-center pos-rel">
                                                        <a href="{{route('user.produk.detail', ['id' => $prod->id])}}"><img
                                                                src="{{ asset($prod->image) }}" alt=""></a>

                                                    </div>
                                                    <div class="product__content">
                                                        <h2 class="product__title"><a
                                                                href="{{route('user.produk.detail', ['id' => $prod->id])}}">{{ $prod->name }}</a></h2>
                                                        <span class="product__available">Available:
                                                            <span>{{ $prod->name }}</span></span>
                                                        <div class="product__progress progress color-primary">
                                                            <div class="progress-bar" role="progressbar"
                                                                style="width: 50%" aria-valuenow="50" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <h4 class="product__price"><span class="new">Rp.
                                                                {{ number_format($prod->price, 2, '.', ',') }}</span></h4>
                                                    </div>
                                                    <div class="product__action-wrap">
                                                        <span class="plus-icon"><i class="fal fa-plus"></i></span>
                                                        <ul class="product__action2">
